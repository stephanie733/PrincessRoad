...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile`, function (sprite, location) {
    pink_car = sprites.create(assets.image`myImage0`, SpriteKind.Enemy)
    pink_car.vx = 140
})
...
let pink_car_dos: Sprite = null
let pink_car: Sprite = null
let mySprite: Sprite = null
tiles.setCurrentTilemap(tilemap`level1`)
scene.setBackgroundColor(7)
mySprite = sprites.create(assets.image`myImage`, SpriteKind.Player)
tiles.placeOnTile(mySprite, tiles.getTileLocation(5, 97))
mySprite.setStayInScreen(true)
controller.moveSprite(mySprite)
scene.cameraFollowSprite(mySprite)
for (let value of tiles.getTilesByType(assets.tile`myTile`)) {
    pink_car = sprites.create(assets.image`myImage0`, SpriteKind.Enemy)
    tiles.placeOnTile(pink_car, value)
}
for (let value of tiles.getTilesByType(assets.tile`myTile1`)) {
    pink_car_dos = sprites.create(assets.image`myImage1`, SpriteKind.Enemy)
    tiles.placeOnTile(pink_car_dos, value)
}
for (let value of tiles.getTilesByType(assets.tile`transparency16`)) {
    bubble = sprites.create(assets.image`bubble`, SpriteKind.Food)
    tiles.placeOnTile(bubble, value)
